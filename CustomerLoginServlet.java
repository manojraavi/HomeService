...
//				request.getRequestDispatcher("customerreg.html").forward(request, response);
		...
		else if (submitType.equals("HOME SERVICE")) {
...
//			System.out.println(l.getVendornumber());
			...
			request.setAttribute("random", "MSJNC"+l.getRand());
			System.out.println("verify"+rand);
			request.setAttribute("amount", amount);
			System.out.println(custname+"email "+custemail+" "+custnum+"  "+vendorid+"  "+vendornum+"  "+servicetype+"  "+category+"  "+address+"  "+rand);
			...
			System.out.println(upiname+"  "+upiemail+ "  "+upi+"  "+rand+" "+amount);
			if (MyDbImpl.customerbooking(cvendorid, customerid, cname, cnum, cservicetype, ccategory, address) > 0) {
