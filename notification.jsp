...
<table align="center">
	...
	<table>
		<form name="myForm" action="VendorLoginServlet" onsubmit="return accept()" method="post">
			...
			<table>
				...
				<tr>
					...
					<td><input type="email" required name="vcemail" size="40"
						placeholder="Enter Customer Emailid"></td>
					<b>Contact Number:</b>&emsp;&emsp;&emsp;
					<input type="tel" required id="telnum1" size="30" name="telnum1"
						placeholder="Enter your phone number" pattern="[789]{1}[0-9]{9}">&emsp;&emsp;&emsp;
					<b>Avalible Timings:</b>&emsp;&emsp;&emsp;
					<input type="time" required id="avltime1" name="avltimefrom1">
					&emsp;&emsp;
					<b>to &emsp;&emsp;</b>
					<input type="time" required id="avltime1" name="avltimeto1">
					<br>
					<br>
					<b>Location: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</b>
					<input type="text" size="30" required id="location" name="location1"
			...
			<input type="submit" name="submit" id="submit" class="adminregsubmit" onclick = "return accept()"
						value="Accept">
</form>
<br>
<br>
<b><u>If the Service are Completed Fill the Deatils to Close :</u></b>
<br>
<br>
<form name="myForm" action="VendorLoginServlet" onsubmit="return complete()" method="post">
	<table>
		
		<tr>
			<td><b>Service Type: </b>&emsp;&emsp;&emsp;&emsp;
					<select required name="servicetype1" id="servicetype1"
			...
			<b>Categories: </b>
					...
					<br>
					<br>
					<td><b>Other Category:&emsp;&emsp;&emsp;</b>
					<input size="30" type="text"
						placeholder="Other category you want to add" name="category11">&emsp;&emsp;&emsp;
		</tr>
		<tr>  <tr>
		<b>Customer EmailId:</b>&emsp;&emsp;&emsp;
				<input type="email" required id="email" size="30" name="custemail"
						placeholder="Enter Customer email id" >&emsp;&emsp;&emsp;</td><br><br>
						</tr>
	</table>
	<br>	<input type="submit" name="submit" id="submit" class="adminregsubmit"
						value="Completed">
		</form>
	</table>
</body>
