...
<table >
	...
	<table>
		<form name="myForm" action="CustomerLoginServlet" target="_blank"
						...
						<%
							try {
								...
								PreparedStatement ps = conn
										.prepareStatement("select distinct vendorid,telnum,avltimefrom,avltimeto,location,servicetype,categories,status from Vendorservice where servicetype=? and location=? ");
								String servicetype = (String) request.getAttribute("servicetype");
								String city = (String) request.getAttribute("city");
								PreparedStatement ps1 = conn.prepareStatement("select distinct customeremail,servicetype,amount from discount where servicetype=? and customeremail=? ;");
								ps1.setString(2,(String)request.getAttribute("custid"));
			...
			<h2>Please fill the details for contacting Service Provider as :</h2>
			<table>
				<tr>
